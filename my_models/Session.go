...
type Session struct {
	...
	SessionToken string    `boil:"sessionToken" json:"sessionToken" toml:"sessionToken" yaml:"sessionToken"`
...
var SessionWhere = struct {
	...
	SessionToken: whereHelperstring{field: "`Session`.`sessionToken`"},
	UserId:       whereHelperstring{field: "`Session`.`userId`"},
	Expires:      whereHelpertime_Time{field: "`Session`.`expires`"},
}
...
var (
	sessionAllColumns            = []string{"id", "sessionToken", "userId", "expires"}
	sessionColumnsWithoutDefault = []string{"id", "sessionToken", "userId", "expires"}

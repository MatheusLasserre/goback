...
type User struct {
	...
	EmailVerified null.Time   `boil:"emailVerified" json:"emailVerified,omitempty" toml:"emailVerified" yaml:"emailVerified,omitempty"`
...
var UserWhere = struct {
	...
	EmailVerified whereHelpernull_Time
	...
	EmailVerified: whereHelpernull_Time{field: "`User`.`emailVerified`"},
...
var (
	userAllColumns            = []string{"id", "name", "email", "emailVerified", "image", "password"}
	userColumnsWithoutDefault = []string{"id", "name", "email", "emailVerified", "image", "password"}

...
var ExampleWhere = struct {
	...
	ID:        whereHelperstring{field: "`Example`.`id`"},
	CreatedAt: whereHelpertime_Time{field: "`Example`.`createdAt`"},
	UpdatedAt: whereHelpertime_Time{field: "`Example`.`updatedAt`"},
}
...
var (
	exampleAllColumns            = []string{"id", "createdAt", "updatedAt"}
	exampleColumnsWithoutDefault = []string{"id", "updatedAt"}
	exampleColumnsWithDefault    = []string{"createdAt"}
